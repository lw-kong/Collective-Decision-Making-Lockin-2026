function [acc,u,g,G_ts] = func_main_sim_1(omega_s, num_agents, T, dt, k, omega_g, noise_sigma)
...
for t = 2:len_time_steps
    ...
    for i = 1:num_agents
        ...
        available_indices = setdiff(1:num_agents, i);
        selected_indices = randsample(available_indices, k);
